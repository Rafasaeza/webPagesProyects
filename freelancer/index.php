    ...
    <main class="contenedor sombra">
            ...
            <div class="servicios">
                <section class="servicio">
                    ...
                    <p>I have make some web frontend web applications using HTML CSS and JS </p>
                </section>
                ...
                <section class="servicio">
                    ...
                    <p>I have work with JAVA since the first year of the university, the proyect I would remark is a social network developed using JAVA Spring Boot
                        </p>
                </section>
                ...
                <section class="servicio">
                    ...
                    <p>I have used php in differents occasions for web development using it for the backend</p>
                </section>
                <section class="servicio">
                    <h3>SQL</h3>
                    <div class="icons">
                    ...
                    <p>I have experience with sql for differents proyect like the social network made with JAVA Spring Boot and a realstate web made with PHP</p>
                </section>
            </div>
    </main>
